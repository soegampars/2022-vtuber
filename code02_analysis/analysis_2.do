...
local model1 ln_views	careerlength careerlength_sq i.debut i.agency_code i.author_code##i.contenttype_code nvideo
local model2 ln_views	careerlength careerlength_sq i.debut i.agency_code i.author_code##i.contenttype_code
...
// 	forval x = 1/3{
	...
	esttab model*, star(* 0.10 ** 0.05 *** 0.01) se(%7.2f) nobase l keep(careerlength careerlength_sq 1.debut *.agency_code nvideo)
	est clear
